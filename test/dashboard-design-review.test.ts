    ...
    reviewed_states: [
      ...
      },
      {
        ...
        pending_review: {
          ...
          reason: 'The Agents section changed after this approval: Turn on and Turn off remote access, the Let\'s Encrypt agreement panel, and the not-connected relay-unavailable and awaiting-agreement states. The approval above covers the earlier render only; the candidate below awaits Jamie\'s re-approval.',
