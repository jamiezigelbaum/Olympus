  ...
  expect(receipt).toEqual({
    ...
    reviewed_states: [
      ...
      },
      {
        ...
        // The Agents section has changed since that approval. The approval
        // stays on record for the render it covered; the candidate is what
        // renders now, and only Jamie can approve it (moving the candidate
        // into rendered_html_sha256 and dropping pending_review).
        pending_review: {
          requested_on: '2026-09-25',
          reason: 'The Agents section changed after this approval: Turn on and Turn off remote access, the Let\'s Encrypt agreement panel, the not-connected relay-unavailable and awaiting-agreement states, and the worker.env address note. The approval above covers the earlier render only; the candidate below awaits Jamie\'s re-approval.',
          candidate_rendered_html_sha256: 'f9628dc809afff7f7e23f9ce7d5c6b1d94ed57ed104a345bfce108524c0dae13',
        },
      },
    ],
    decisions: [
