...
- SHA-256: `fb8d176d34b530c438ee567e1e74efa2a584a45ae5d6885b64eb91f391aef922`
- Byte count: `968934`

1. Fetch that exact release as JSON over HTTPS. Require a successful HTTP
   response, `tag_name` equal to `v0.4.0-beta.2`, `prerelease` equal to `true`,
...
2. Select exactly one uploaded asset named `olympus-0.4.0-beta.2.tgz` from `assets`.
