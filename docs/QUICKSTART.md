...
[pilot release](https://github.com/jamiezigelbaum/Olympus/releases/tag/v0.4.0-beta.4)
and choose `olympus-0.4.0-beta.4.tgz` under Assets, not a source-code archive. Compare
...
olympus worker upgrade --artifact /absolute/path/to/olympus-0.4.0-beta.4.tgz
