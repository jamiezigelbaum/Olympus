  ...
  if (isGoogleOAuthSource(source)) {
    ...
    return {
      ...
      finish: desktop
        ...
        : 'Press Create, copy the Client ID from the confirmation dialog into the field below, and press Connect. PKCE protects the exchange, so there is no client secret to paste.',
    };
  }
  if (source === 'dropbox') {
    return {
